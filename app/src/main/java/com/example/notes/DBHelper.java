...
public class DBHelper {
    ...
    public void createTable(){
        sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS notes" + "(id INTEGER PRIMARY KEY, username TEXT, data TEXT, title TEXT, content TEXT, scr TEXT)");
    }
    ...
    public void saveNotes(String username, String title, String content, String date){
        createTable();
        sqLiteDatabase.execSQL(String.format("INSERT INTO notes (username, data, title, content) VALUES ('%s', '%s', '%s', '%s')",
